#!/usr/bin/env python3
"""
Debug vegetation indices with correct tile h24v05
"""
...
print(f"Testing vegetation indices with correct tile:")
print(f"  Point: ({lat}, {lon})")
print(f"  Date: {date.date()}")
print(f"  DOY: {doy}")

# Use the correct tile (h24v05)
tile = "h24v05"
print(f"  Using tile: {tile}")
